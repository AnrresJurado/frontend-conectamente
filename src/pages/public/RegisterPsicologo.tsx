...
const RegisterPsicologo: React.FC = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      // Estructura limpia adaptada al CreatePsicologoDto del backend
      ...
      message.success("¡Cuenta de Psicólogo registrada! Ya puedes iniciar sesión.");
      navigate("/login");
    } catch (err: any) {
      console.error(err);
      if (err.response && err.response.status === 409) {
        setError("El correo electrónico o la licencia profesional ya están registrados.");
      ...
      <Row style={{ width: "100%", minHeight: "100vh" }}>
        ...
        <Col xs={24} md={12} style={styles.rightPanel}>
          <div style={styles.formCard}>
            <h2 style={styles.title}>Registro Profesional</h2>
            <p style={styles.subtitle}>Ingresa tus credenciales de psicología</p>
            ...
            >
              ...
              <Form.Item style={{ marginBottom: 0 }}>
                <Button
                  ...
                  block
                >
                  {loading ? "Registrando..." : "Crear Cuenta de Psicólogo"}
                </Button>
              </Form.Item>
            </Form>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  title: { color: "#1d5863", fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 26, fontWeight: 800, margin: 0, textAlign: "center" },
